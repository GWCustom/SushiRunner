...
sidebar = dbc.Container(children=charge_switch + [ 
    ...
    dbc.Button("Submit", id=f'{title}_submit1', n_clicks=0, style={"margin-top": "18px", 'borderBottom': '1px solid lightgrey'})
...
@app.callback(
    ...
    [
        ...
        State(id("dataset"), "data"),
        State(id("datatable"), "selected_rows"),
        State(id("token_data"), "data"),
        State(id("entity"), "data"),
        State(id("app_data"), "data")
    ],
